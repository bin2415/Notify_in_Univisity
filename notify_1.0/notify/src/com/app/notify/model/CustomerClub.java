...
public class CustomerClub extends BaseModel{
	...
	// default is no login
			...
			static private CustomerClub customer = null;
	...
	static public CustomerClub getInstance () {
		if (CustomerClub.customer == null) {
			CustomerClub.customer = new CustomerClub();
		}
		return CustomerClub.customer;
	}
