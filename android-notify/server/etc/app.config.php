 ...
 */
define('__HOST_SERVER', 'http://192.168.56.1:9001');
define('__HOST_WEBSITE', 'http://192.168.56.1:9002');
...
define('__FACE_DIR', realpath(__WWW_DIR . '/website/faces'));
define('__FACE_URL', __HOST_WEBSITE . '/faces/');